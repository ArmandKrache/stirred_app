...
import 'package:stirred_app/presentation/cubits/drink/drink_cubit.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_hooks/flutter_hooks.dart';
import 'package:stirred_app/presentation/cubits/profile/profile_cubit.dart';
import 'package:stirred_app/presentation/widgets/rating_dialog_widget.dart';
...
class DrinkView extends StatefulHookWidget {
  ...
  const DrinkView({super.key, required this.id});
...
class _DrinkViewState extends State<DrinkView> {
  ...
  void initState() {
    ...
    if (state is ProfileLoaded) {
      isFavorite = state.profile.preferences.favorites.any((element) => element.id == widget.id);
    }
  }
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Text("${formatDifficulty(drink.recipe.difficulty)} - ${drink.recipe.preparationTime} minutes ⏳"),
                ],
              ),
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              const SizedBox(),
              Text(formatDateTimeDeltaFromNow(rating.creationTime),
